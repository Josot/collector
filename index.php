...
<body>
    <main>
        <header id="header" style="background-color: #222;">
            ...
            <div class="header-content">
                <video class="header-video" src="./media/video/homepage_video.mp4" autoplay muted loop></video>

                <div class="area">
                    <div class="container grid-2">
                        <div class="column-1">
                            <h1 class="header-title" style="color: white;">Moto Garage</h1>
                            ...
                            <a href="./inventory/" class="btn">Look at our inventory!</a>
                            <br><br>
                            <a href="./about-us/index.php" class="btn">About us!</a>
                        </div>
